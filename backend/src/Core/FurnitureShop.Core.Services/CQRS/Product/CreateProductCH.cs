...
namespace FurnitureShop.Core.Services.CQRS.Product
{
    ...
    public class CreateProductCH : ICommandHandler<CoreContext, ExampleCommand>
    {
        private readonly Serilog.ILogger logger = Serilog.Log.ForContext<CreateProductCH>();
